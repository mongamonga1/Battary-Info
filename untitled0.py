...
Original file is located at
    https://colab.research.google.com/drive/1I5UtIs3BBtZv5SXa3weeqXkwvGPYFTHu
"""
...
로컬 개발 시 ➡️ `.streamlit/secrets.toml` 파일에 아래처럼 키를 보관하고,
Streamlit Cloud 배포 시 ➡️ 앱 Dashboard > **Settings → Secrets** 메뉴에서 동일한 키를 추가하세요.

[secrets.toml]
ODCLOUD_SERVICE_KEY = "YOUR_REST_API_KEY"
"""
